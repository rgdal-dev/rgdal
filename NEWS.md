...
* Removed dependence on rgeos and maptools. 

* Removed tests requiring rgeos (all to do with the SPComment). 

* Removed pkg subfolder. 

* Deleted vignettes/ ChangeLog and oChangeLog and svn2cl.xsl. 

* Fork created 2023-09-26, full history at https://github.com/r-forge/rgdal/commit/79f08a5dea4310ce11584eff365867f9fdd76d8a
